package org.flixel.data;
	...
	class FlxPanel extends FlxObject {
		 ...
		 * @private
		 */
		var _donate:FlxButton;
		/**
		 * @private
		 */
		var _stumble:FlxButton;
		/**
		 * @private
		 */
		var _digg:FlxButton;
		 ...
		 * @private
		 */
		var _reddit:FlxButton;
		/**
		 * @private
		 */
		var _delicious:FlxButton;
		/**
		 * @private
		 */
		var _twitter:FlxButton;
		/**
		 * @private
		 */
		 ...
		 * @private
		 */
		var _caption:FlxText;
		/**
		 * @private
		 */
		var _payPalID:String;
		/**
		 * @private
		 */
		var _payPalAmount:Float;
		/**
		 * @private
		 */
		var _gameTitle:String;
		/**
		 * @private
		 */
		var _gameURL:String;
		 ...
		 */
		public function setup(PayPalID:String,PayPalAmount:Float,GameTitle:String,GameURL:String,Caption:String):Void
		{
			_payPalID = PayPalID;
		 ...
		 */
		public function show(?Top:Bool=true):Void
		{
			if(_closed) return;
			if(!_initialized)
			{
